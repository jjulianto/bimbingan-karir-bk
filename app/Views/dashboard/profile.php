        ...
        <div class="row py-4 px-3" id="profile-form">
            ...
            <div class="col-lg-10 col-md-10 col-12 prof2">
                ...
                <div class="form-group">
                    <label for="exampleInputNipNis">NIP / NIS</label>
                    <input type="number" class="form-control" id="exampleInputNipNis" aria-describedby="NIShelp" placeholder="Masukkan NIP / NIS">
                </div>
                <div class="form-row">
